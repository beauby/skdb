...
- payload
  ...
  - 8: access key (65 * 8 = 520) - ECDSA public key
  - 73 (35): nonce (8 * 8 = 64)
  - 81 (43): signature (32 * 8 = 256)
  - 113 (111): reserved (7) must be zeroed
  - iso length 0 for 24, 1 for 27 (1)
  - 114 (112): iso date (24 * 8 = 192 or 27 * 8 = 216 depending on iso length flag)
  - 138/141 (136/139): client_version_length (8)
  - 139/142 (137/140): client_version (client_version_length * 8) - ASCII encoded string identifying this client
